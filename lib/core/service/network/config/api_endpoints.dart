/// Class containing endpoints for the API.
class ApiEndpoints {
  /// Base URL for the API.
  static String baseUrl = "https://qa-testing-backend-293b1363694d.herokuapp.com//api/v3/mobile-guests/";

  /// Endpoint for user events.
  static String userEventsEndpoint = "user-events";

  /// Fixed token for authentication.
